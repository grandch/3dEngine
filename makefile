...
CFLAGS = -Wall
EXEC_NAME = engine
INCLUDES = main.cpp Scene.cpp Camera/Camera.cpp Importer/Importer.cpp Shaders/Shader.cpp Models/Cube.cpp Inputs/Input.cpp Mesh/Mesh.cpp Mesh/MeshVertex.cpp Mesh/MeshHalfEdge.cpp Mesh/MeshTriangle.cpp Mesh/MeshEdge.cpp
LIBS = -lGL -lSDL2
